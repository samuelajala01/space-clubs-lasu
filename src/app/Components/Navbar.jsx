  ...
  return (
    ...
    >
      <div className="flex justify-center w-full mt-4">
        {/* Mobile Nav */}
        <div className="md:hidden flex justify-between items-center px-4 py-4 w-[95%] rounded-full text-white shadow-md relative bg-white/5 backdrop-blur-md">
          <button
          ...
          <Link href="/join">
            <button className="bg-[#f65d2a] text-white rounded-full py-2 px-4 hover:bg-[#e04c1a] transition-colors text-sm">
              Join Now
            </button>
          </Link>
        ...
        {/* Desktop Nav */}
        <div className="hidden md:flex justify-center items-center gap-[4vw] px-8 py-6 w-fit rounded-full text-white shadow-md relative bg-white/5 backdrop-blur-md">
          ...
          <ul className="flex gap-[3vw] items-center">
            <li>
              <Link href="/">Home</Link>
            </li>
            <li>
